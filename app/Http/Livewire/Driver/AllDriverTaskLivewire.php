...
class AllDriverTaskLivewire extends Component
{
    public $oPending = 0;
    public $oShipping = 0;
    public $oDelivered = 0;
    ...
    // protected $listeners = ['echo:orders,EventOrderStatusUpdated' => 'reloadTable'];
    ...
    public function render()
    {
        ...
        $query = Order::with([
            'driverUser.profile','orderItems.product' => function ($query) use ($locale) {
            }
        ]);
        ...
        return view('super-admins.pages.tasks.alldrivertasks.order-table', [
            'orderTable' => $orders,
        ]);
    }
}