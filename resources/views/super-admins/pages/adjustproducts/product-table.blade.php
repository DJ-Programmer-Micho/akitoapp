...
<style>
    ...
    <script>
        ...
        function updatePriceValue(itemId) {
            ...
            var updatePrice = input.value;
            @this.call('updatePrice', itemId, updatePrice);
        }
        function updateDiscountValue(itemId) {
            var input = document.getElementById('discount_' + itemId);
            var updateDiscount = input.value;
            @this.call('updateDiscount', itemId, updateDiscount);
        }
