                                                ...
                                                <span>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end" style="">
                                                            ...
                                                            <li>
                                                                <a type="button" class="dropdown-item edit-list" target="_blank" href="{{route('super.customerProfile', ['locale' => app()->getLocale(),'id' => $data->id])}}">
                                                                    <i class="fa-regular fa-eye me-2"></i>{{__('View')}}
                                                                </a>
                                                            </li>
                                                            <li class="dropdown-divider"></li>
                                                            <li>
                                                                <button type="button" class="dropdown-item edit-list" data-bs-toggle="modal" data-bs-target="#updateCustomerModal" wire:click="editUser({{ $data->id }})">
