<div class="page-content">
    <div class="container-fluid">
        @include('super-admins.pages.customerlist.customer-form',[$title = "Avatar"])
        <!-- start page title -->
        <div class="row">
            <div class="col-12">
                                ...
                                <table class="table align-middle" id="customerTable">
                                    <thead class="table-light text-muted">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="country">Country - City</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            <td class="customer_name @empty($data->customer_profile->first_name) text-danger @endif align-middle">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ $data->customer_profile && $data->customer_profile->avatar ? app('cloudfront').$data->customer_profile->avatar : $customerImg}}" alt="{{ $data->customer_profile && $data->customer_profile->first_name ? $data->customer_profile->first_name : 'user'}}" class="img-fluid" style="max-width: 60px; max-height: 60px; object-fit: cover;">
                                                    </div>
                                                    <div>
                                            ...
                                            <td class="phone">{{$data->customer_profile->country}} - {{$data->customer_profile->city}}</td>
                                                ...
                                                <span>
                                                    <div class="dropdown"><button
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end" style="">
                                                            ...
                                                            <li><button type="button" class="dropdown-item edit-list" data-bs-toggle="modal" data-bs-target="#updateCustomerModal" wire:click="editUser({{ $data->id }})">
