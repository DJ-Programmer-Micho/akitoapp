<div class="page-content">
    @include('super-admins.pages.intensities.intensity-form')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{__('Intensity')}}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{__('Dashboard')}}</a></li>
                            <li class="breadcrumb-item active">{{__('Intensity')}}</li>
                        </ol>
                    </div>
                ...
                <div class="card-header border-0">
                    <div class="row g-4">
                        <div class="col-sm-auto">
                            <div>
                                <button wire:loading.attr="disabled" type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addIntensityModal" data-bs-placement="top" title="{{__('Add Intensity')}}">
                        ...
                        <div class="col-sm">
                            <div class="d-flex justify-content-sm-end">
                                <div class="search-box ms-2">
                                    <input type="search" wire:model="search" class="form-control" id="searchProductList" placeholder="{{__('Search Intensitys...')}}">
                            ...
                            <table class="table table-bordered table-striped table-hover table-sm">
                                ...
                                <tbody>
                                    @forelse($tableData as $data)
                                        <tr wire:key="size-{{ $data->id }}">
                                            <td class="@empty($data->min && $data->max)  text-danger @endif align-middle">{{ $data->min . '/' . $data->max ?? 'unKnown' }}</td>
                                            ...
                                            <td class="align-middle text-center">
                                                <div class="d-flex justify-content-center align-items-center">
                                                    ...
                                                    <button type="button" class="btn btn-warning btn-icon text-dark"  onclick="updatePriorityValue({{ $data->id }})">
                                                        <i class="fas fa-sort" loading="lazy"></i>
                                                    </button>
                                                </div>
                                            </td>
                                            <td class="align-middle text-center">
                                                    ...
                                                    <div class="dropdown"><button
                                                        wire:loading.attr="disabled"
                                                            ...
                                                            aria-expanded="false"><i
                                                                class="ri-more-fill" loading="lazy"></i></button>
                                                        <ul class="dropdown-menu dropdown-menu-end" style="">
                                                            <li><button class="dropdown-item" type="button" wire:click="updateStatus({{ $data->id }})">
                                                                ...
                                                                @if ( $data->status == 1)
                                                                <span class="text-danger"><i class="fa-solid fa-xmark me-2" loading="lazy"></i> {{__('De-Active')}}</span>
                                                                @else
                                                                <span class="text-success"><i class="fa-solid fa-check me-2" loading="lazy"></i> {{__('Active')}}</span>
                                                                @endif
                                                                </button>
                                                            </li>
                                                            <li><button type="button" class="dropdown-item edit-list" data-bs-toggle="modal" data-bs-target="#updateIntensityModal" wire:click="editIntensity({{ $data->id }})" wire:loading.attr="disabled" >
                                                                <i class="fa-regular fa-pen-to-square me-2"></i>{{__('Edit')}}</button>
                                                            </li>
                                                            <li class="dropdown-divider"></li>
                                                            <li><button type="button" class="dropdown-item edit-list" data-bs-toggle="modal" data-bs-target="#deleteIntensityModal" wire:click="removeIntensity({{ $data->id }})">
