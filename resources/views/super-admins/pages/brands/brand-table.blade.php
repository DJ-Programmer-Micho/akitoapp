                                ...
                                <table class="table table-bordered table-striped table-hover table-sm">
                                    ...
                                    <tbody>
                                        @forelse($tableData as $data)
                                            <tr wire:key="brand-{{ $data->id }}">
                                                <td class="@empty($data->brandtranslation->name) text-danger @endif align-middle">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-2">
                                                            <img src="{{ app('cloudfront').$data->image }}" alt="{{ $data->brandtranslation->name }}" class="img-fluid" style="max-width: 60px; max-height: 60px; object-fit: cover; background-color: #f8d7da;">
                                                        </div>
                                                        <div>
                                                            <h6 class="mb-0">{{ $data->brandtranslation->name ?? 'unKnown' }}</h6>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <span>
                                                        <div class="dropdown"><button
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                                ...
                                                                <li><button type="button" class="dropdown-item edit-list" data-bs-toggle="modal" data-bs-target="#updateBrandModal" wire:click="editBrand({{ $data->id }})">
                        ...
                        <form wire:submit.prevent="saveBrand">
                            ...
                            <div class="filter-choices-input">
                                @foreach ($filteredLocales as $locale)
                                    <div class="mb-3">
                                        <label for="brands.{{ $locale }}" class=" @if($locale != 'en') ar-shift @endif">{{__('In ' . $locale . ' Language')}}</label>
                                        <input type="text" 
                                            ...
                                            wire:model="brands.{{ $locale }}" placeholder="{{__('Brand Name')}}">
                                        @error('brands.' . $locale)
