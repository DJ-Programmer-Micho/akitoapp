<div class="page-content">
    @include('super-admins.pages.capacities.capacity-form')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{__('Capacity')}}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">{{__('Dashboard')}}</a></li>
                            <li class="breadcrumb-item active">{{__('Capacity')}}</li>
                        </ol>
                    </div>
                        ...
                        <div class="card-header border-0">
                            <div class="row g-4">
                                <div class="col-sm-auto">
                                    <div>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addCapacityModal" data-bs-placement="top" title="{{__('Add Capacity')}}">
                                ...
                                <div class="col-sm">
                                    <div class="d-flex justify-content-sm-end">
                                        <div class="search-box ms-2">
                                            <input type="search" wire:model="search" class="form-control" id="searchProductList" placeholder="{{__('Search capacities...')}}">
                                ...
                                <table class="table table-bordered table-striped table-hover table-sm">
                                    ...
                                    <tbody>
                                        @forelse($tableData as $data)
                                            ...
                                            <tr>
                                                <td class="@empty($data->variationCapacityTranslation->first()->name)  text-danger @endif align-middle">{{ $data->variationCapacityTranslation->first()->name ?? 'unKnown' }}</td>
                                                    ...
                                                    <span>
                                                        <div class="dropdown"><button
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                                                ...
                                                                <li><button type="button" class="dropdown-item edit-list" data-bs-toggle="modal" data-bs-target="#updateCapacityModal" wire:click="editCapacity({{ $data->id }})">
                                                                    <i class="fa-regular fa-pen-to-square me-2"></i>{{__('Edit')}}</button>
                                                                </li>
                                                                <li class="dropdown-divider"></li>
                                                                <li><button type="button" class="dropdown-item edit-list" data-bs-toggle="modal" data-bs-target="#deleteCapacityModal" wire:click="removeCapacity({{ $data->id }})">
