                                        ...
                                        @forelse($tableData as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#updateCapacityModal" data-bs-placement="top" title="{{__('Edit Capacity')}}" wire:click="editCapacity({{ $data->id }})"
                                                    >
                                                        <i class="fas fa-edit fa-lg"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-danger btn-icon" 
                                                    data-bs-toggle="modal" data-bs-target="#deleteCapacityModal" data-bs-placement="top" title="{{__('Delete Capacity')}}" wire:click="removeCapacity({{ $data->id }})"
                                                    >
