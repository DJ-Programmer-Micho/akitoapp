                        ...
                        <div class="card-header border-0">
                            <div class="row g-4">
                                <div class="col-sm-auto">
                                    <div>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addSizeModal" data-bs-placement="top" title="{{__('Add Size')}}">
                                        ...
                                        @forelse($tableData as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#updateSizeModal" data-bs-placement="top" title="{{__('Edit Size')}}" wire:click="editSize({{ $data->id }})"
                                                    >
                                                        <i class="fas fa-edit fa-lg"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-danger btn-icon" 
                                                    data-bs-toggle="modal" data-bs-target="#deleteSizeModal" data-bs-placement="top" title="{{__('Delete Size')}}" wire:click="removeSize({{ $data->id }})"
                                                    >
