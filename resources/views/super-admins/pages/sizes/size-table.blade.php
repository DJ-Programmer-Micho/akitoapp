<div class="page-content">
    @include('super-admins.pages.sizes.size-form')
                ...
                <div class="card-header border-0">
                    <div class="row g-4">
                        <div class="col-sm-auto">
                            <div>
                                <button wire:loading.attr="disabled" type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addSizeModal" data-bs-placement="top" title="{{__('Add Size')}}">
                        ...
                        <div class="col-sm">
                            <div class="d-flex justify-content-sm-end">
                                <div class="search-box ms-2">
                                    <input type="search" wire:model="search" class="form-control" id="searchProductList" placeholder="{{__('Search Sizes...')}}">
                                                ...
                                                <span>
                                                    <div class="dropdown"><button
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end" style="">
                                                            ...
                                                            <li><button type="button" class="dropdown-item edit-list" data-bs-toggle="modal" data-bs-target="#updateSizeModal" wire:click="editSize({{ $data->id }})" wire:loading.attr="disabled" >
