            ...
            <div class="dropdown ms-sm-3 header-item topbar-user">
                <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="d-flex align-items-center">
                        <img class="rounded-circle header-profile-user" src="{{isset(auth()->guard('admin')->user()->profile->avatar) ? app('cloudfront').auth()->guard('admin')->user()->profile->avatar : app('userImg')}}" alt="{{auth()->guard('admin')->user()->profile->first_name . ' ' . auth()->guard('admin')->user()->profile->last_name}}">
                        <span class="text-start ms-xl-2">
                            ...
                            <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{auth()->guard('admin')->user()->profile->position}}</span>
                        </span>
                    </span>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    @if (auth()->guard('admin')->user()->roles[0]->id == 1)
