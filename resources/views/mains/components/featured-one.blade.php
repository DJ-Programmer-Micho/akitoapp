            ...
            <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                ...
                <div class="product product-2">
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a href="{{ route('business.productDetail', ['locale' => 'en','slug' => $item->productTranslation->slug])}}">{{$item->productTranslation->name}}</a></h3><!-- End .product-title -->
