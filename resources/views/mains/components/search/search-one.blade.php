        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="product-body product-action-inner">
                    ...
                    <div class="product-content nav-dir">
                    ...
                    <div class="product-price mt-1 fw-bold">
                        <span class="w-100 price flip-symbol" style="text-decoration: line-through; color: #cc0022; font-size: 16px">
                    ...
                    @else
                        <div class="product-price mt-1 fw-bold price flip-symbol">
                            <span class="amount">{{ number_format($product->base_price, 0) }}</span>
                            <span class="currency">{{ __('IQD') }}</span>
                        </div><!-- End .product-price -->
                    @endif
