<div class="megamenu demo">
    <h4 class="py-1 text-center">{{ __('Coming Soon Brands') }}</h4><!-- End .menu-title -->
    <div class="row">
        @foreach($soons as $soon)
        <div class="col-6 col-sm-4 col-md-3 col-lg-2 mt-1">
            <a href="javascript:void(0);"> 
                <div class="demo-bg-wrapper-page">
                    <span class="demo-bg-page" style="background-image: url('{{ app('cloudfront').$soon->image }}');"></span>
                </div>
                <div class="text-center">{{ $soon->coming_soon_translation->name }}</div>
